      ...
      <div className="border-b border-slate-200 bg-slate-50">
        <Container className="flex flex-wrap items-center justify-between gap-x-6 gap-y-2 py-2 text-xs sm:text-sm text-slate-700">
          ...
          <div className="flex flex-wrap items-center justify-end gap-x-5 gap-y-2">
            <a href="mailto:michellecarterconsultancy@outlook.ie" className="inline-flex items-center gap-1.5 transition-colors hover:text-brand-700" aria-label="Email">
              ...
              <span className="hidden md:inline">michellecarterconsultancy@outlook.ie</span>
            </a>

            <a href="tel:0874255819" className="inline-flex items-center gap-1.5 transition-colors hover:text-brand-700" aria-label="Phone">
              <svg viewBox="0 0 20 20" className="h-4 w-4 text-slate-500" aria-hidden="true" fill="currentColor">
              ...
              <span className="hidden md:inline">0874255819</span>
            </a>
          </div>
        </Container>
      </div>
